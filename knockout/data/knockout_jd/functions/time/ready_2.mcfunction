playsound block.note_block.hat music @a
    execute if score #i r matches 1.. run title @a title [{"score":{"objective":"r","name":"#i"},"color": "dark_aqua","bold": true}]
    execute if score #i r matches 0 run title @a title [{"text":"START","color":"dark_aqua","bold":true}]
