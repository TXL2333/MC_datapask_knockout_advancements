...
bossbar add time {"text": "游戏未开始","bold": true}
...
scoreboard objectives remove initialization
    ...
    scoreboard objectives add SCORE dummy [{"text":"得分","color":"dark_aqua","bold": true}]
