...
execute as @r[team= dark_aqua,tag=!out] run tellraw @a [{"text": "DRAK_AQUQ WIN 得分：","bold": true,"color": "yellow"},{"score":{"name":"#red","objective": "sum","bold": true,"color": "yellow"}}]
execute as @r[team= dark_gray,tag=!out] run tellraw @a [{"text": "DRAK_GRAY WIN 得分：","bold": true,"color": "yellow"},{"score":{"name":"#red","objective": "sum","bold": true,"color": "yellow"}}]
execute as @r[team= gold,tag=!out] run tellraw @a [{"text": "GOLD WIN 得分：","bold": true,"color": "yellow"},{"score":{"name":"#red","objective": "sum","bold": true,"color": "yellow"}}]
execute as @r[team= light_purple,tag=!out] run tellraw @a [{"text": "LIGHT_PURPLE WIN 得分：","bold": true,"color": "yellow"},{"score":{"name":"#red","objective": "sum","bold": true,"color": "yellow"}}]
