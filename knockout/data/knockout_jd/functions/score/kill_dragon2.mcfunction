...
execute as @s[team= dark_aqua,tag=!out] run tellraw @a [{"text": "DRAK_AQUQ WIN 解放末地 得分：","bold": true,"color": "yellow"},{"score":{"name":"#red","objective": "sum","bold": true,"color": "yellow"}}]
execute as @s[team= dark_gray,tag=!out] run tellraw @a [{"text": "DRAK_GRAY WIN 解放末地 得分：","bold": true,"color": "yellow"},{"score":{"name":"#red","objective": "sum","bold": true,"color": "yellow"}}]
execute as @s[team= gold,tag=!out] run tellraw @a [{"text": "GOLD WIN 解放末地 得分：","bold": true,"color": "yellow"},{"score":{"name":"#red","objective": "sum","bold": true,"color": "yellow"}}]
execute as @s[team= light_purple,tag=!out] run tellraw @a [{"text": "LIGHT_PURPLE WIN 解放末地 得分：","bold": true,"color": "yellow"},{"score":{"name":"#red","objective": "sum","bold": true,"color": "yellow"}}]
