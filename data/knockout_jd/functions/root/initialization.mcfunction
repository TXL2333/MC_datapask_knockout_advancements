...
#统计有玩家的团队数|#i|team
execute if score #i team matches 1 run tellraw @a [{"text":"▶当前仅一个团队无法进行游戏","bold":true,"color": "dark_aqua"},{"text":"【进入单人挑战】","bold": true,"color": "dark_aqua","clickEvent":{"action":"run_command","value":"/function knockout_jd:root/single_player"},"hoverEvent":{"action":"show_text","value":"单人游戏 Single player game"}}]
