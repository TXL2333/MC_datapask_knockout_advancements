...
execute as @r[team=dark_aqua,tag=!out] run tellraw @a [{"text": "=====","bold": true,"color": "yellow"},{"text": "蓝-","bold":true,"color": "dark_aqua"},{"text": "胜出 | 得分","bold": true,"color": "yellow"},{"score":{"name":"#dark_aqua","objective": "sum","bold": true,"color": "yellow"}},{"text": "=====","color": "yellow","bold": true}]
execute as @r[team=red,tag=!out] run tellraw @a [{"text": "=====","bold": true,"color": "yellow"},{"text": "红-","bold":true,"color": "red"},{"text": "胜出 | 得分：","bold": true,"color": "yellow"},{"score":{"name":"#red","objective": "sum","bold": true,"color": "yellow"}},{"text": "=====","color": "yellow","bold": true}]
execute as @r[team=dark_gray,tag=!out] run tellraw @a [{"text": "=====","bold": true,"color": "yellow"},{"text": "灰-","bold":true,"color": "dark_gray"},{"text": "胜出 | 得分：","bold": true,"color": "yellow"},{"score":{"name":"#dark_gray","objective": "sum","bold": true,"color": "yellow"}},{"text": "=====","color": "yellow","bold": true}]
execute as @r[team=gold,tag=!out] run tellraw @a [{"text": "=====","bold": true,"color": "yellow"},{"text": "金-","bold":true,"color": "gold"},{"text": "胜出 | 得分：","bold": true,"color": "yellow"},{"score":{"name":"#gold","objective": "sum","bold": true,"color": "yellow"}},{"text": "=====","color": "yellow","bold": true}]
execute as @r[team=light_purple,tag=!out] run tellraw @a [{"text": "=====","bold": true,"color": "yellow"},{"text": "粉-","bold":true,"color": "light_purple"},{"text": "胜出 | 得分：","bold": true,"color": "yellow"},{"score":{"name":"#light_purple","objective": "sum","bold": true,"color": "yellow"}},{"text": "=====","color": "yellow","bold": true}]
