...
title @a title [{"text":"=================","color": "yellow","bold": true},{"text":"Round ","color": "yellow","bold": true},{"score":{"name": "#i","objective": "Round"},"bold": true,"color": "yellow"},{"text":"=================","color": "yellow","bold": true}]
